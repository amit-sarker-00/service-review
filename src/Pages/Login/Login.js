        ...
        <div className="w-full px-6 py-4 mt-6 overflow-hidden bg-white shadow-2xl sm:max-w-lg sm:rounded-lg">
            ...
            <div className="mt-4">
              ...
              <div className="flex flex-col items-start">
                <input
                  ...
                  name="email"
                  placeholder="email"
                  className="block w-full mt-1  rounded-md shadow-xl border focus:ring p-2"
                  required
                />
              </div>
            </div>
          ...
          <div className="my-6 space-y-2">
            ...
            <button
              ...
              className="btn flex items-center justify-center w-full p-4 space-x-4 border rounded-md dark:border-gray-400 "
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 32 32"
